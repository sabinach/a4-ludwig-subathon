...
Another consideration when designing the website was whether the visualization makes sense to people not familiar with Twitch or Ludwig’s subathon. After some user tests, I also noticed that some jargon that was familiar to me (ie. “followers”, “subs”, “subathon”, “streamer”, etc), might not be common knowledge to people not familiar with the Twitch or live streaming community. Therefore, to help provide some context to the visualization, I added a [?] hoverable tooltip that can explain new vocabulary, as well as an overall info section on the top right corner of the page that provides the context of the subathon to new users.  
